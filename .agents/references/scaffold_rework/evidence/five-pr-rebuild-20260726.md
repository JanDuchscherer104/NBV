...
- [MemPalace v3.6.0](https://github.com/MemPalace/mempalace/releases/tag/v3.6.0):
  stable release; verify package hash, commit, license, and public APIs before
  implementation.
...
- [Closets design](https://github.com/MemPalace/mempalace/blob/develop/docs/CLOSETS.md):
  drawers preserve content; closets are compact pointers.
- [Source adapter RFC 002](https://github.com/MemPalace/mempalace/blob/develop/docs/rfcs/002-source-adapter-plugin-spec.md):
...
Current accepted artifacts remain at their native role paths. Only superseded
bundles move byte-identically to `.omx/archive/accepted-bundles/<bundle-id>/`.

**Deliverables:**

- snapshot PR #28 metadata/check result, then close it with a supersession note;
- accepted six-role bundle containing report, complete responsibility matrix,
...
- verified stable MemPalace v3.6.0 pin/license/public commands;
