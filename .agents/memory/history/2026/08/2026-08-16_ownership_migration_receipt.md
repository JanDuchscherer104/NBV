...
| retired-035-workflow | `.agents/memory/state/DECISIONS.md` / `8fcabeffed7c898b6c7d0ec02c65e24097ea68d8` / `0c72a15bd633f8c67fafd3b79204ac1c63200282` / `workflow` (12-39) | workflow/source-order decisions | historical | `.agents/references/source_order.md#Compositional Owner Tree` | verified: guidance check |
