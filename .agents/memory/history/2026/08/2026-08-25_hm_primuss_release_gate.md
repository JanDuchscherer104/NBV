...
## Findings
`docs/typst/thesis/development/roadmap.typ` now records the applicable-SPO, registration, finalization, conditional-copy, and final-PDF human checks. Upload, local builds, PDF digests, and repository fields remain explicitly insufficient to prove submission; signature and attachment requirements remain conditional on authenticated records.
