...
Tracked rollout-generation configuration now names VIN V10 as the canonical
source and the V11 pilot as the current corrected campaign. Generated V11
artifacts provide the replacement training/inspection corpus; no persistence
schema or historical artifact was mutated.
