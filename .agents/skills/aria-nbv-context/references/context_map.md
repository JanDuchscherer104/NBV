...
| Candidate generation and pose sampling | `aria_nbv/aria_nbv/pose_generation/` | `aria_nbv/AGENTS.md` | `docs/typst/seminar_paper/sections/08-system-pipeline.typ` | `docs/reference/index.qmd`, `docs/typst/thesis/sections/01-research-questions.typ#ssec:rq4` | `literature/tex-src/arXiv-GenNBV/3-Method.tex` | `aria_nbv/aria_nbv/pose_generation/` | `scripts/nbv_get_context.sh match candidate` |
