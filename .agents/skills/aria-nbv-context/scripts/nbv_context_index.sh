...

{
  ...
  echo "| Shared scientific language | \`docs/typst/shared/glossary.typ\`, \`symbols.typ\`, \`equations.typ\` | You need a durable term, symbol, equation, or printed notation entry. |"
