...
| Paragraph | Claim type | Claim | Evidence path | Citation/result | Status |
| --- | --- | --- | --- | --- | --- |
...
| P3 | Implementation fact | The current repository stores ... | defining code + focused tests + active configuration | path/result | unchecked |
| P4 | Limitation | This does not establish continuous-control deployment. | thesis boundary | none needed | checked |

Required statuses: `unchecked`, `checked`, `downgraded`, or `hypothesis`.
