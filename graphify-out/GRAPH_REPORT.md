...
## Summary
- 11112 nodes · 20214 edges · 489 communities (473 shown, 16 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 1737 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `90d98d4e1c72d6779a78827e1dc5ef6bd12f6dad`
...
## Communities (489 total, 16 thin omitted)
...
Cohesion: 0.04
Nodes (94): Canonical root sample for diagnostics and rollout generation.      `VinOfflineSa, VinOfflineSample, camera_tw_pinhole_kwargs(), candidate_centers_world(), depth_hw(), deterministic_downsample(), display_rot90_cw(), image_hwc() (+86 more)
...
Cohesion: 0.04
Nodes (68): Run one diagnostic VIN forward pass and restore the prior model mode.      Args:, run_vin_diagnostics(), build_vin_snippet_view(), collapse_vin_points(), empty_vin_snippet(), pad_vin_points(), device, Tensor (+60 more)
...
Cohesion: 0.05
Nodes (47): CompactObbBlock, CompactTrajectoryBlock, Shared VIN oracle batch records, masking, and collation utilities.  This module, Collatable numeric OBB payload used by training and diagnostics.      ``obbs`` k, Preserve MPS/EFM timing and gravity metadata beside VIN trajectory poses., dtype, ndarray, PerspectiveCameras (+39 more)
...
Cohesion: 0.07
Nodes (63): collect_vin_offline_dataset_stats(), NumericSummary, Per-row sanity summary for one sampled VIN offline record., Summarize finite numeric values., Finite-value summary for one numeric diagnostic series., Collect coverage, shape, RRI, and memory diagnostics for a VIN store.      Args:, _summary(), VinOfflineSampleDiagnostic (+55 more)
...
Cohesion: 0.05
Nodes (61): _BackboneAccumulator, _batch_shape_preview(), _broadcast_ref_pose(), _candidate_pose_values(), _collect_backbone_diagnostics(), _collect_block_diagnostics(), collect_vin_offline_dataset_coverage(), _component_for_memory_block() (+53 more)
...
Cohesion: 0.06
Nodes (29): Any, device, Figure, Path, Tensor, Log and reset stage-owned candidate ranking accumulators., Initialize learnable CORAL bin values from the fitted binner., Initialize CORAL biases from fitted class priors (if configured). (+21 more)
...
Cohesion: 0.04
Nodes (33): eqs_action_angle_cap_transform(), eqs_action_capped_direction(), eqs_action_family_directions(), eqs_action_power_spherical_forward(), symb_use_L6_2_shape_Nq_407ef9c0(), symb_use_L70_1_shape_Nq_407ef9c0(), symb_use_L8_1_shape_Nq_407ef9c0(), term_ground_truth() (+25 more)
...
Cohesion: 0.06
Nodes (54): Render immutable root-observation-store diagnostics., _backbone_rows(), _block_rows(), _component_rows(), _coverage_rows(), _load_offline_store_from_toml(), _memory_rows(), _pose_rows() (+46 more)
...
Cohesion: 0.07
Nodes (28): device, PerspectiveCameras, PoseTW, Tensor, Return clamped valid-prefix lengths as ``Tensor["", int64]`` or ``Tensor["B", in, Return ``Tensor["N", bool]`` or ``Tensor["B N", bool]`` valid-prefix masks., Return a copy with candidate ordering randomly permuted.          The permutatio, Collate cached VIN batches by padding candidate sets to a shared length. (+20 more)

### Community 60 - "Community 60"
Cohesion: 0.08
Nodes (31): Initialize mandatory binner-derived state before direct inference.          This, Yield oracle-labelled VIN batches from the wrapped raw dataset., Adapt one online Oracle label result to the model-facing batch., _vin_batch_from_label(), _atomic_torch_save(), _atomic_write_text(), ordinal_labels_to_levels(), Any (+23 more)
...
Cohesion: 0.07
Nodes (29): Path, Self, Build a block descriptor for one Zarr-backed numeric array.          Args:, Build a block descriptor for indexed per-row MessagePack records.          Args:, Top-level manifest for one immutable VIN offline dataset.      Attributes:, Descriptor for one stored block inside a shard.      Attributes:         name: L, Persist the manifest to disk.          Args:             path: Destination manif, Read the global sample index.          Args:             path: ``sample_index.js (+21 more)
...
Cohesion: 0.06
Nodes (22): term_aria_synthetic_environments(), term_egocentric_foundation_model_3d(), term_egocentric_voxel_lifting(), term_use_L7_1_relative_reconstruction_improvem_f9d7e62d(), term_use_L7_2_aria_synthetic_environments_57d9ab1a(), term_use_L7_3_egocentric_foundation_model_3d_a3428ddc(), term_use_L9_1_ground_truth_short_f1a35f23(), term_use_L3_1_aria_synthetic_environments_57d9ab1a() (+14 more)
...
Cohesion: 0.08
Nodes (26): build_projection_grid(), encode_projection_summary(), project_points_to_candidate_cameras(), Any, device, dtype, PerspectiveCameras, Tensor (+18 more)
...
Cohesion: 0.07
Nodes (20): symb_use_L1058_1_rl_qh_3a1a25cb(), symb_use_L1186_1_rl_qh_3a1a25cb(), symb_use_L395_1_rl_qh_3a1a25cb(), symb_use_L395_2_rl_qh_3a1a25cb(), symb_use_L498_1_rl_qh_3a1a25cb(), symb_use_L112_1_rl_qh_3a1a25cb(), symb_use_L112_2_rl_qh_3a1a25cb(), symb_use_L42_1_rl_qh_3a1a25cb() (+12 more)
...
Cohesion: 0.11
Nodes (24): _compact_or_live_gt_obbs(), _detected_obbs(), _latest_valid_obb_slice(), _obb_boxes(), _obb_family(), _obb_line_strips(), ObbTW, PoseTW (+16 more)
...
Cohesion: 0.11
Nodes (14): Return the registered scorer through the structural VIN protocol.          `self, CandidateScorer, CandidateScorerPrediction, Any, PerspectiveCameras, PoseTW, Protocol, Tensor (+6 more)
...
Cohesion: 0.12
Nodes (14): flush_prepared_samples_to_shard(), PreparedVinOfflineSample, Path, Normalized offline row before shard materialization.      Attributes:         sa, Materialize a list of prepared rows into one immutable shard.      Args:, Compose raw data, Oracle labels, optional features, and offline codecs., Initialize the pipeline and its runtime dependencies.          Args:, Return the candidate budget stored per sample. (+6 more)
...
Cohesion: 0.12
Nodes (9): Path, Load the global sample indices for one split.          Args:             split:, Return index records for the requested split.          Args:             split:, Return the resolved path to the store-owned ``manifest.json``., Return the resolved path to the global ``sample_index.jsonl``., Return the absolute shard root directory., Return the absolute split-array directory., Return the split-array path for one split.          Args:             split: Spl (+1 more)
...
Cohesion: 0.20
Nodes (12): _as_candidate_matrix(), candidate_order_consistency(), candidate_policy_entropy(), _candidate_valid_matrix(), CandidateOrderConsistency, _masked_argmax(), Tensor, Compare candidate scores before and after a candidate-order shuffle.      Args: (+4 more)

### Community 221 - "Community 221"
Cohesion: 0.16
Nodes (10): candidate_best_value(), candidate_masked_mean(), CandidateTableMetrics, _finite_mask(), Reduce candidate-table values with a hard validity mask.      Args:         valu, Return the best finite candidate value under a hard mask.      Args:         val, Accumulate hard-mask candidate-table diagnostics.      The metric reports valid/, Accumulate candidate hard-mask validity without value summaries. (+2 more)
...
Cohesion: 0.23
Nodes (11): _as_path_matrix(), candidate_primary_invalid_reason_share(), candidate_provenance_share(), CandidatePrimaryInvalidReasonStats, _id_membership(), Operational validity, provenance, path, and policy audits for rollouts.  This mo, Compute per-table share of candidates from selected provenance families.      Ca, Summarize primary invalid-reason concentration among rejected rows.      Args: (+3 more)

### Community 248 - "Community 248"
Cohesion: 0.20
Nodes (8): CandidateOrderConsistencyMetric, CandidatePolicyEntropyMetric, CandidateProvenanceShareMetric, MetricBase, Accumulate shuffled-candidate order-consistency diagnostics.      This metric su, Accumulate masked candidate-policy entropy diagnostics.      The metric summariz, Accumulate candidate provenance-family share diagnostics.      The metric report, Accumulate one batch of candidate provenance tables.
...
Cohesion: 0.25
Nodes (7): coral_logits_to_prob(), Tensor, Return ``Tensor["K", float32]`` monotone representatives ``u_k``., Decode ``Tensor["... K", float32]`` class probabilities to a continuous RRI prox, Repair ``Tensor["... K-1", float32]`` logits to marginals and decode their RRI p, Return scalar mean-squared deviation from ``Tensor["K", float32]`` target bin va, Convert cumulative CORAL logits to repaired class marginals.      Args:
...
Cohesion: 0.29
Nodes (4): Return shuffled-candidate consistency diagnostics., Return mean entropy or ``NaN`` when no table had positive mass., Return finite mean family share or ``NaN`` when no tables were valid., _safe_mean()

### Community 315 - "Community 315"
Cohesion: 0.29
Nodes (4): CandidatePrimaryInvalidReasonMetric, Accumulate primary invalid-reason share among rejected candidates.      The conf, Accumulate one batch of primary invalid-reason ids., Return reason-group share and denominator-validity rate.
...
Cohesion: 0.67
Nodes (3): Any, Hash source and semidense-collapse settings for VIN payload compatibility., vin_snippet_cache_config_hash()
...
- **Why does `PathConfig` connect `Community 33` to `Community 130`, `Community 3`, `Community 4`, `Community 5`, `Community 133`, `Community 135`, `Community 8`, `Community 10`, `Community 139`, `Community 396`, `Community 397`, `Community 144`, `Community 17`, `Community 20`, `Community 23`, `Community 153`, `Community 284`, `Community 29`, `Community 35`, `Community 38`, `Community 173`, `Community 50`, `Community 57`, `Community 60`, `Community 61`, `Community 62`, `Community 69`, `Community 70`, `Community 107`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `EfmSnippetView` connect `Community 124` to `Community 2`, `Community 4`, `Community 132`, `Community 7`, `Community 18`, `Community 19`, `Community 146`, `Community 21`, `Community 24`, `Community 25`, `Community 28`, `Community 29`, `Community 286`, `Community 161`, `Community 162`, `Community 163`, `Community 37`, `Community 42`, `Community 301`, `Community 174`, `Community 51`, `Community 189`, `Community 70`, `Community 199`, `Community 72`, `Community 77`, `Community 78`, `Community 85`, `Community 87`, `Community 95`, `Community 225`, `Community 101`, `Community 250`, `Community 125`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `Console` connect `Community 83` to `Community 130`, `Community 2`, `Community 4`, `Community 132`, `Community 133`, `Community 7`, `Community 8`, `Community 139`, `Community 18`, `Community 21`, `Community 24`, `Community 153`, `Community 25`, `Community 28`, `Community 29`, `Community 31`, `Community 33`, `Community 35`, `Community 300`, `Community 173`, `Community 51`, `Community 54`, `Community 57`, `Community 62`, `Community 70`, `Community 199`, `Community 78`, `Community 339`, `Community 88`, `Community 223`, `Community 224`, `Community 225`, `Community 101`, `Community 125`?**
