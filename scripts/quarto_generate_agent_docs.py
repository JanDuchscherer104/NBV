...
DOC_SPECS: tuple[DocSpec, ...] = (
    ...
    DocSpec(
        ...
        output="evidence/memory_readme.qmd",
        title="Agent Memory README",
        section="Agent Evidence",
        nav_label="Memory README",
        summary="Overview of dated debrief, transcript, and migration evidence.",
    ),
    DocSpec(
...
def render_index() -> None:
    ...
    lines = [
        ...
        "",
        "It includes the active `AGENTS.md` files, dated-evidence guidance, agent",
