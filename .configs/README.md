...
| `build_rollouts_v1_cuda_campaign_pilot_corrected_v6.toml` | Corrected paired pilot | `build_rollouts_v1_cuda_campaign_writer.toml` |
...
uv run nbv-rollout-campaign plan \
  --config-path ../.configs/build_rollouts_v1_cuda_campaign_pilot_corrected_v6.toml \
...
uv run nbv-rollout-campaign run \
  --config-path ../.configs/build_rollouts_v1_cuda_campaign_pilot_corrected_v6.toml \
  --plan-path .campaign/cuda-rollouts-v1-pilot-corrected-v6/plan.json \
  --max-new-units 10
