...
class OracleRRIConfig(TargetConfig["OracleRRI"]):
    """Configure deterministic point fusion for :class:`OracleRRI`."""

    @property
    def target_type(self) -> type["OracleRRI"]:
        """Return the runtime oracle class constructed by ``setup_target()``."""
        return OracleRRI
...
class OracleRRI:
    ...
    def score_batch(
        ...
        *,
        ...
        """Delegate to :meth:`score` for legacy callers using the batch name."""
