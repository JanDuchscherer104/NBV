...
class EfmObbView(BaseView):
    ...
    hypotheses must come from EVL predictions or tracking instead. Downstream
    target selection transforms the latest valid slice into world coordinates
    before constructing Oracle target tasks.
    """
