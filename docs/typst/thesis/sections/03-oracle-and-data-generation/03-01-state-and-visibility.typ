...
The target is external task context, so the value is conceptually $Q(s_t,e,a)$
rather than a target-independent state value. The logged history contains the
recorded trajectory evidence,
