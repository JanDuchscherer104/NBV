...
#impl_todo(
  ...
  source: [RQ3 and M3--M4 contracts],
...
#decision_todo(
  ...
  source: [experimental-design and reporting contracts],
...
#validation_todo(
  ...
  source: [rollout attempts and H3--H8 campaign record],
...
#prune_todo(
  ...
  source: [RQ5--RQ6 and M6 contracts],
