...
factorization through a #gh-wip("aria_nbv/aria_nbv/targets/protocol.py", body: [target-provenance boundary], ref: "main", line: 1),
a #gh-wip("aria_nbv/aria_nbv/pose_generation/candidate_mixture.py", body: [mixed candidate generator], ref: "main", line: 1),
#gh-wip("aria_nbv/aria_nbv/data_handling/qh_data/views.py", body: [causal actor and supervision views], ref: "main", line: 1),
separate #gh-wip("aria_nbv/aria_nbv/vin/modules/qh_scene_encoders.py", body: [scene carriers], ref: "main", line: 1) and
#gh-wip("aria_nbv/aria_nbv/vin/modules/qh_history_encoders.py", body: [history encoders], ref: "main", line: 1), and a
