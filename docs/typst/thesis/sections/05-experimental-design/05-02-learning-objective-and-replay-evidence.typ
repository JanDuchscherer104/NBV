...
evaluation are the implemented estimator; they address max bias but do not
create transition support @DoubleDQN-vanHasselt2015. A single-estimator frozen
lower-horizon maximum remains a planned matched control until it has an
executable configuration and receipt. The experiment therefore reports
horizon-specific population, calibration, terminal fraction, bootstrap support,
and exact-$Q_2$ coverage before any endpoint comparison.
