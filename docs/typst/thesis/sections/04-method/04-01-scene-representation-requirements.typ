...
#figure(
  text(size: 8.2pt, table(
    ...
    [`S1-points`], [causally fused selected surface points], [Implemented privileged fixed-width residual over current-camera point sets; does not distinguish observed free from unknown space.],
...
#figure(
  text(size: 8.2pt, table(
    ...
    [Selected-surface point memory], [implemented privileged control], [Strictly causal surfaces follow selected views; fixed-width residual preserves matched downstream scorer initialization.], [No free/unknown or ray identity; test density, source dropout, runtime, and held-out value.],
