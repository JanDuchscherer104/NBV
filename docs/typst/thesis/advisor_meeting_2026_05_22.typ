    ...
    [
      #color-block(title: [Conflict rule], spacing: 0.4em)[
        #slide-small[
          ...
          - `questions.qmd` remains the owner for unresolved advisor decisions.
    ...
    [
      #color-block(title: [Eligibility and matching], spacing: 0.28em)[
        ...
        #decision_todo(
          ...
          sources: [`main.typ`; archived advisor handout; `questions.qmd`],
        )
      ]
    ],
  )
    ...
    [
      #color-block(title: [Open critic / surrogate questions], spacing: 0.34em)[
        ...
        #decision_todo(
          ...
          sources: [historical outlook deck; `questions.qmd`],
        )
      ]
    ],
  )
      ...
      #color-block(title: [Advisor locks that change interpretation], spacing: 0.38em)[
        #slide-small[
          #decision_todo(
            ...
            sources: [questions; `questions.qmd`],
          )
          #v(0.22em)
          #decision_todo(
    ...
    [
      #color-block(title: [Evidence protocol to lock], spacing: 0.45em)[
        #slide-small[
          ...
          #v(0.18em)
          #decision_todo([Target matching thresholds and ambiguity policy.], sources: [`questions.qmd`])
          #v(0.18em)
          #decision_todo(
