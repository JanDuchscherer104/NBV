...
#let aria-notation-equations = (
  ...
  (key: "rl.target_rri_reward", tex: "r_t^e=(\\Delta_t^e-\\Delta_{t+1}^e)/(\\Delta_0^e+\\varepsilon)", description: "Normalized factual target-root reconstruction gain at rollout step t.", thesis_list: false, order: 9999),
  (key: "rl.observed_cumulative_root_gain", tex: "G_{0:s,\\mathrm{root}}^e=\\sum_{k=0}^{s-1}r_{k,\\mathrm{root}}^e", description: "Observed cumulative target-root gain through factual rollout step s.", thesis_list: false, order: 9999),
