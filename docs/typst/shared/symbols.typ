...
#let aria-notation-symbols = (
  ...
  (key: "rl.requested_horizon", tex: "h", description: "Requested residual horizon for a finite-horizon value query.", thesis_list: true, order: 371),
  (key: "rl.max_horizon", tex: "H_{\\max}", description: "Maximum horizon supported by the model and training data contract.", thesis_list: true, order: 372),
  ...
  (key: "rl.source_role", tex: "\\ell_{t,i}^{\\mathrm{src}}", description: "Actor-oracle source-provenance role for candidate evidence.", thesis_list: true, order: 386),
