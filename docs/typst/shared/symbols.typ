...
#let aria-notation-symbols = (
  ...
  (key: "rl.conditional_q", tex: "Q_{h,\\theta,e,i}^{\\mathrm{cond}}", description: "Action-mask-independent conditional candidate value emitted by the scorer.", thesis_list: true, order: 351),
