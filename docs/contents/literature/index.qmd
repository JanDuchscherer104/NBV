...
- [Instance-aware object-centric 3DGS NBV](3dgs_instance_nbv.qmd): focused source-backed distillation of per-Gaussian instance state, confidence-weighted block information, target gating, quantitative evidence, and the concrete ATEK/EVL adaptation path [@ObjectCentricNBV-jeong2026].
...
- [`figures/external/arXiv/Instance-NBV/`](../../figures/external/arXiv/Instance-NBV/): the three selected source-derived PNGs used by the Instance-NBV review.
