...
- [Instance-aware object-centric 3DGS NBV](3dgs_instance_nbv.qmd): exhaustive source-backed review of per-Gaussian instance logits, confidence-weighted block information, target gating, quantitative evidence, mathematical risks, backbone choice, and a leakage-clean ATEK snippet adaptation [@ObjectCentricNBV-jeong2026].
...
- [`figures/external/arXiv/Instance-NBV/`](../../figures/external/arXiv/Instance-NBV/): all eight source PDFs, rendered previews, and checksums used by the Instance-NBV review.
