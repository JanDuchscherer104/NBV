...
| EFM3D / EVL [@EFM3D-straub2024; @EVL-Doc-2025] | Local egocentric evidence and predicted object support. | DINO/EVL local evidence, pre-head features, OBB predictions, actor-visible target descriptors, support masks. | Treating predicted OBBs as GT, ignoring local extent limits, or treating EVL heads as the complete scene memory. |
...
z_e^{\mathrm{oracle}}
=
\psi_{\mathrm{task}}\!\left(O_{\mathrm{GT}}, P_t^{\mathrm{semi}}, F_t^{\mathrm{EVL}}, I_{1:t}\right),
\qquad
M_e =
