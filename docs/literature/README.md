...
- [3D-NVS: A 3D Supervision Approach for Next View Selection](https://arxiv.org/abs/2012.01743): Uses an ImageNet-pretrained VGG16 classifier for fixed-view NBV prediction and provides a direct counterexample to blanket no-pretraining claims. Local source tree: `arXiv-3D-NVS/`.
